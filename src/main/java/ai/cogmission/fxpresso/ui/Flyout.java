/* ---------------------------------------------------------------------
 * Copyright (C) 2015, David Ray.  Unless you have an agreement
 * with David Ray, for a separate license for this software code, the
 ...
 * ---------------------------------------------------------------------
 */
package ai.cogmission.fxpresso.ui;
